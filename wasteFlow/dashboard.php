            ...
            <div class="grid-container">
                <div class="card">
                    ...
                    <div class="card-actions">
                        <a href="user_input.html" class="action-link">Input</a>
                        <a href="user_output.html" class="action-link">Output</a>
                    </div>
                </div>
                <div class="card">
                    <span class="card-icon">📝</span>
                    ...
                    <div class="card-actions">
                        <a href="request_input.html" class="action-link">Input</a>
                        <a href="request_output.html" class="action-link">Output</a>
                    </div>
                </div>
                <div class="card">
                    <span class="card-icon">🗑</span>
                    ...
                    <div class="card-actions">
                        <a href="bin_input.html" class="action-link">Input</a>
                        <a href="bin_output.html" class="action-link">Output</a>
                    </div>
                </div>
            </div>
            <div class="grid-container">
                <div class="card">
                    ...
                    <div class="card-actions">
                        <a href="schedule_input.html" class="action-link">Input</a>
                        <a href="schedule_output.html" class="action-link">Output</a>
                    </div>
                </div>
                <div class="card">
                    <span class="card-icon">💬</span>
                    ...
                    <div class="card-actions">
                        <a href="feedback_input.html" class="action-link">Input</a>
                        <a href="feedback_output.html" class="action-link">Output</a>
                    </div>
                </div>
                <div class="card">
                    <span class="card-icon">🔎</span>
                    ...
                    <div class="card-actions">
                        <a href="analysis_input.html" class="action-link">Input</a>
                        <a href="analysis_output.html" class="action-link">Output</a>
                    </div>
                </div>
            </div>
            <div class="grid-container">
